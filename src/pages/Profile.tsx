...
const Profile = () => {
  const { user } = useAuth();
  const { profile, preferences, updateProfile, updatePreferences, isUpdating } =
    useProfile();
          ...
          <CardContent>
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                For security, API keys are stored in Supabase Edge Functions.
                Contact your administrator to configure API integrations for
                widgets.
              </p>
              <p className="text-xs text-muted-foreground">
                This includes: News APIs, Weather services, Financial data
                providers, Sports feeds, and Social media integrations.
              </p>
            </div>
          </CardContent>
        </Card>
