...
export const useWidgets = () => {
  ...
  const addWidgetMutation = useMutation({
    mutationFn: async (widget: Omit<UserWidget, 'id' | 'user_id' | 'created_at' | 'updated_at'>) => {
  ...
  const updateWidgetMutation = useMutation({
    mutationFn: async ({ id, ...updates }: Partial<UserWidget> & { id: string }) => {
      if (!user) throw new Error('User not authenticated');
  ...
  return {
    ...
    isUpdating: addWidgetMutation.isPending || updateWidgetMutation.isPending || deleteWidgetMutation.isPending,
    getCachedData,
    setCachedData,
  };
};