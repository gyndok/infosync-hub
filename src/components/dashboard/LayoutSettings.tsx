...
const AVAILABLE_WIDGETS = [
  ...
  { id: "clock", name: "World Clock", description: "Multiple timezone clocks" },
  {
    id: "khou_sports",
    name: "KHOU Sports",
    description: "Houston sports news",
  },
  {
    id: "khou_astros",
    name: "Houston Astros",
    description: "Astros baseball news",
  },
  {
    id: "khou_rockets",
    name: "Houston Rockets",
    description: "Rockets basketball news",
  },
  {
    id: "khou_texans",
    name: "Houston Texans",
    description: "Texans football news",
  },
  {
    id: "khou_local",
    name: "Houston Local News",
    description: "Local Houston news",
  },
  {
    id: "houston_traffic",
    name: "Houston Traffic",
    description: "Real-time traffic and metro alerts",
  },
  {
    id: "texas_longhorns",
    name: "Texas Longhorns",
    description: "Texas Longhorns football news",
  },
];
        ...
        <div className="space-y-6">
                  ...
                  {AVAILABLE_WIDGETS.filter(
                    (widget) =>
                      !layoutConfig.widgets.some(
                        (w) => w.id === widget.id || w.type === widget.id,
                      ),
                  ).map((widget) => (
          ...
          <div className="space-y-3">
            ...
            <RadioGroup
              ...
              onValueChange={(value) =>
                updateColumnCount(Number(value) as 2 | 3)
              }
            >
